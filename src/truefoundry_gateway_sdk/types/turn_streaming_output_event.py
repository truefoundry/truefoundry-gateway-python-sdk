...
class TurnStreamingOutputEvent(UniversalBaseModel):
    audio: typing.Optional[TurnStreamingOutputEventAudio] = None
    content: typing.Optional[typing.List[AgentMcpInitializationInfo]] = None
    function_call: typing.Optional[TurnStreamingOutputEventFunctionCall] = None
    name: typing.Optional[str] = None
    refusal: typing.Optional[str] = None
    thinking_blocks: typing.Optional[typing.List[TurnStreamingOutputEventThinkingBlocksItem]] = None
    ...
    usage: typing.Optional[TurnStreamingOutputEventUsage] = None
    ...
    context: typing.Optional[typing.List[TurnStreamingOutputEventContextItem]] = None
