...
from truefoundry_gateway_sdk.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from truefoundry_gateway_sdk.core.request_options import RequestOptions
...
@patch("truefoundry_gateway_sdk.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("truefoundry_gateway_sdk.core.http_client.asyncio.sleep", new_callable=AsyncMock)
